      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        {status === "loading" ? (
          ...
          <>
            ...
            <Link
              href="/auth/signin"
              className="block w-full py-2.5 px-4 text-sm font-medium text-white bg-black dark:bg-white dark:text-black rounded-lg hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors text-center"
              aria-label="Sign in"
            >
              Sign in
            </Link>
